	...
	<div>
		...
		<Row>
			...
			<div className="main-error-wrapper wrapper-1 page page-h">
				...
				<h6 className="">You may have mistyped the address or the page may have moved.</h6><Link className="btn btn-primary" to={`${process.env.PUBLIC_URL}/dashboard`}>Back to Home</Link>
			</div>
			{/* <!-- /Main-error-wrapper --> */}
