          ...
          <Card>
            <Card.Header className=" pb-0">
              ...
              <p className="tx-12 tx-gray-500 mb-2">
                Example of Epi Simple Table. <Link to="#">Learn more</Link>
              </p>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={12}>
          <Card>
            <Card.Header className=" pb-0">
              ...
              <p className="tx-12 tx-gray-500 mb-2">
                Example of Epi Striped Rows.. <Link to="#">Learn more</Link>
              </p>
            </Card.Header>
            <Card.Body>
              <div className="table-responsive">
        ...
        <Col xl={12}>
          <div className="card mg-b-20">
            <Card.Header className=" pb-0">
              ...
              <p className="tx-12 tx-gray-500 mb-2">
                Example of Epi Bordered Table.. <Link to="#">Learn more</Link>
              </p>
            </Card.Header>
            <Card.Body>
              <div className="table-responsive">
        ...
        <Col xl={12}>
          <Card>
            <Card.Header className=" pb-0">
              ...
              <p className="tx-12 tx-gray-500 mb-2">
                Example of Epi Hoverable Rows Table.. <Link to="#">Learn more</Link>
              </p>
            </Card.Header>
            <Card.Body>
              <div className="table-responsive">
