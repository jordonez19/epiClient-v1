...
export const VerticalMenu = () => {
  ...
  name();
  localStorage.setItem("Epivertical", 'true');
  localStorage.removeItem("Epihorizontal");
  localStorage.removeItem("EpihorizontalHover");
...
export const horizontal = () => {
  ...
  localStorage.removeItem("Epivertical");
  localStorage.setItem("Epihorizontal", 'true');
  localStorage.removeItem("EpihorizontalHover");
}
// };
export const HorizontalHoverMenu = () => {
  ...
  localStorage.removeItem("Epivertical");
  localStorage.setItem("EpihorizontalHover", 'true');
  localStorage.removeItem("Epihorizontal");
};
// Color theme
export const LightTheme = () => {
  ...
  localStorage.removeItem("Epidark");
  localStorage.setItem("Epilighttheme", 'true');
  localStorage.removeItem("Epitransparent");
...
export const dark = () => {
  ...
  htmldark.style = "";
  name();
  localStorage.removeItem("Epilighttheme");
  localStorage.setItem("Epidark", 'true');
  localStorage.removeItem("Epitransparent");
  localStorage.removeItem("EpiBgImage")
...
export const transparent = () => {
  ...
  localStorage.removeItem("Epilighttheme");
  localStorage.setItem("Epitransparent", 'true');
  localStorage.removeItem("Epidark");
  localStorage.removeItem("EpiBgImage")
};
...
export function bgimage2() {
  ...
  document.querySelector(".app")?.classList.remove("light-theme");
  document.querySelector(".app")?.classList.remove("dark-theme");
  localStorage.setItem("EpiBgImage", "bg-img2");
  let htmltransparentbody: any = document.querySelector("html")
  htmltransparentbody.style.removeProperty("--transparent-body");
...
export function bgimage3() {
  ...
  document.querySelector(".app")?.classList.remove("light-theme");
  document.querySelector(".app")?.classList.remove("dark-theme");
  localStorage.setItem("EpiBgImage", "bg-img3");
  let htmltransparentbody: any = document.querySelector("html")
  htmltransparentbody.style.removeProperty("--transparent-body");
  transparentStyle();
...
export function bgimage4() {
  ...
  document.querySelector(".app")?.classList.remove("light-theme");
  document.querySelector(".app")?.classList.remove("dark-theme");
  localStorage.setItem("EpiBgImage", "bg-img4");
  let htmltransparentbody: any = document.querySelector("html")
  htmltransparentbody.style.removeProperty("--transparent-body");
  transparentStyle();
...
export function localStorageBackUp() {
  ...
  if (localStorage.getItem("EpiBgImage") !== null) {
    let img: any = localStorage.getItem("EpiBgImage");
  ...
  if (localStorage.getItem("EpitransparentPrimaryColor") !== null) {
  ...
  if (localStorage.getItem("EpitransparentBgColor") !== null) {
    body?.classList.add("transparent-theme");
    ...
    html?.setProperty(
      "--transparent-body",
      localStorage.getItem("EpitransparentBgColor")
    );
  }
  if (
    localStorage.getItem("Epitransparent-bgImgPrimaryColor") !== null ||
    localStorage.getItem("EpiBgImage") !== null
  ) {
    body?.classList.add("transparent-theme");
    document.getElementById("myonoffswitchTransparent");
  ...
  if (localStorage.EpihorizontalHover) {
    document.querySelector(".app")?.classList.add("horizontal-hover");
    document.querySelector(".app")?.classList.add("horizontal");
    document.querySelector(".main-content")?.classList.add("horizontal-content");
    document.querySelector(".main-container")?.classList.add("container");
  ...
  if (localStorage.Epidark) {
    let darktheme: any = document.querySelector("#myonoffswitch2") as HTMLInputElement
    darktheme.checked = true;
    dark()
  }
  if (localStorage.Epitransparent) {
    let transparents: any = document.querySelector("#myonoffswitchTransparent") as HTMLInputElement
    transparents.checked = true;
    transparent()
  }
  if (localStorage.Epilighttheme) {
    let lighttheme: any = document.querySelector("#myonoffswitch1") as HTMLInputElement
    lighttheme.checked = true
    LightTheme()
  }
